...
export default function LinhasBU(props:any): JSX.Element{
    ...
    useLayoutEffect(() => {
        montaGrafico(refCanvas.current,refLegenda.current)
    })
...
<>
    ...
    <div>Média Semanal:<div className="valorlinhaBUmedia">{props.media}</div></div></div></div>
</>
)
...
function montaGrafico(Elemento: HTMLCanvasElement | null, Legenda: any, ){
    ...
    let nome = props.titulo,cor = props.cor
